...
const controller = module.controller("OrganiserDashboardController", function($scope, $window, $http){
    ...
    $scope.doUpdatePassword = function() {
        ...
        var email = $scope.activeUserOrganiserEmail;
        ...
        // 3. Send Request
        $http.post("/organiser-update-password", obj).then(function(response) {
            ...
            var myModalEl = document.getElementById('organiserSettingsModal');
